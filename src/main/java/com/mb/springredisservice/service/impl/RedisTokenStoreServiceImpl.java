...
import com.mb.springredisservice.config.RedissonWrapper;
import com.mb.springredisservice.service.RedisTokenStoreService;
...
public class RedisTokenStoreServiceImpl implements RedisTokenStoreService {
    ...
    private final RedissonWrapper redissonWrapper;
    ...
    public String getToken(String tokenId, String key) {
        ...
        if (!StringUtils.hasLength(token)) {
            RLock lock = redissonWrapper.redisson.getLock(key);
